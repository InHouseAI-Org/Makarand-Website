          ...
          >
            <div className="space-y-4">
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 rounded-xl bg-emerald/10 flex items-center justify-center shrink-0 border border-emerald/20">
                  <span className="text-emerald font-bold">13+</span>
                </div>
                <div>
                  <h3 className="text-charcoal font-bold mb-1" style={{ fontSize: "18px" }}>Years of Service</h3>
                  <p className="text-charcoal-light" style={{ fontSize: "15px", lineHeight: "1.6" }}>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-charcoal font-bold mb-1" style={{ fontSize: "18px" }}>Multiple Re-elections</h3>
                  <p className="text-charcoal-light" style={{ fontSize: "15px", lineHeight: "1.6" }}>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-charcoal font-bold mb-1" style={{ fontSize: "18px" }}>Community First</h3>
                  <p className="text-charcoal-light" style={{ fontSize: "15px", lineHeight: "1.6" }}>
