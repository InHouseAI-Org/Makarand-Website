...
export function MediaPreviewClient({ awards, pressItems, galleryImages }: MediaPreviewClientProps) {
  return (
          ...
          >
            ...
            <div className="space-y-4">
              {awards.length > 0 ? (
                ...
                <p className="text-charcoal-light text-center py-4" style={{ fontSize: "14px" }}>
