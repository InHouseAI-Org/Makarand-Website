...
export function MediaDetail({ params }: { params: Promise<{ type: string; id: string }> }) {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/media" className="text-coral hover:text-coral-dark" style={{ fontSize: "15px", fontWeight: 600 }}>
            &larr; Back to Media
          </Link>
        </div>
      </div>
