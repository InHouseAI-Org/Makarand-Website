-- ==========================================
-- CLEAN AND SEED DATA FROM OFFICER LIST A WARD.PDF
-- This script will DELETE existing data and insert fresh data
-- ==========================================
...
DELETE FROM "WardOfficer";

-- ==========================================
-- STEP 2: INSERT WARD OFFICERS (16 Officers)
-- ==========================================
...
-- ==========================================
-- STEP 3: INSERT POLICE STATIONS (5 Stations)
-- ==========================================
...
-- ==========================================
-- STEP 4: INSERT FIRE STATIONS (3 Stations)
-- ==========================================
